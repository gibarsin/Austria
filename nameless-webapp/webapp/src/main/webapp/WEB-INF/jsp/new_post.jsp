    ...
    <div class="row interact">
        ...
        <div class="col-md-6">
            <form:form modelAttribute="postForm" action="${postPath}" method="post" enctype="multipart/form-data">
                <form:input type="text" class="form-control" postId="title" path="title" placeholder="Titulo"></form:input>
                <form:input type="file" path="file" accept="url/png, url/jpeg, url/gif" postId="file" class="form-control input-sm"/>
